...
Скрипт `hack_it.py` Редактирует пользовательские данные
Для работы в корневой папке проекта активируйте виртуальное окружение если не делали этого ранее и введите:
```
$ python3 manage.py shell
```
импортируйте необходимые команды в открывшейся командной строке и активируйте их с необходимыми параметрами